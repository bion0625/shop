...
<html>
	...
	<body>
		...
		<table width="750px" border="1" align="center">
				...
				<tr>
					<td>
						...
						<c:if test="${ vo.del_info == 1 }">
							...
							<c:if test="${ vo.del_info != 1 }">
								<a href="loss_view_list.do?idx=${ vo.idx }&ref=${vo.ref}&page=${empty param.page ? 1 : param.page}">${ vo.subject }</a>
							</c:if>
					</td>
			...
			<tr>
				<td colspan="3"><input type="button" value="글쓰기" onclick="location.href='loss_insert_form.do'"></td>
			</tr>
		</table>
		</div>
	</div>
