...
<html>
	...
	<form action="loss_reply.do" name="f" method="post">
		<table border="1" align="center">
			<caption>::답변을 입력해주세요::</caption>
			<tr>
				<th width="120" height="25">제목</th>
				<td width="250"><input name="subject">
			...
			<tr>
				...
				<input value="목록" type="button" onclick="location.href='loss_list.do'"></td>
			</tr>
		</table>
	</form>
	</div>
