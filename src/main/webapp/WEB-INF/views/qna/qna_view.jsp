...
<html>
	<head>
		...
		<script type="text/javascript">
			function modify() {
				...
				var pwd = '${vo.pwd}';
				if(pwd == c_pwd){
					location.href='qna_modify_form.do?idx=${vo.idx}';
					return;
				}
					alert("비밀번호가 틀립니다");
			}
			function del() {
				...
				location.href='qna_del.do?idx=${vo.idx}';
			}
		</script>
	</head>
	<body>
	<div id="main_box">
		...
		<table border="1" align="center" width="750px">
			...
			<tr>
				<td colspan="3"><input value="목록" type="button" onclick="location.href='qna_list.do?page=${param.page}'">
				<input value="수정" type="button" onclick="modify();">
				<input value="삭제" type="button" onclick="del();">
				<input value="답변" type="button" onclick="location.href='qna_reply_form.do?idx=${vo.idx}'"></td>
			</tr>
		</table>
		</div>
		</div>
